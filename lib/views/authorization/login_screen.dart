...
class _LoginScreenState extends State<LoginScreen> {
  ...
  login() async {
    ...
    if(EmailValidator.validate(emailController.text)) {
      if((!passwordController.text.contains(" ")) && passwordController.text.length >= 6){
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    customText.kText("Login", 30, FontWeight.w800, Colors.black, TextAlign.left),
                    customText.kText("Please sign in to continue", 18, FontWeight.w400, Colors.black, TextAlign.left),
                    ...
                    GestureDetector(
                      child: Align(
                        ...
                        child: customText.kText("Forgot Password?", 18, FontWeight.w700, Colors.black, TextAlign.start),
                      ),
                      onTap: () {
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: isApiCalling
                            ...
                            : customText.kText("Login", 30, FontWeight.w700, Colors.white, TextAlign.center),
                        ),
                      ),
                      onTap: () {
                    ...
                    GestureDetector(
                      child: Container(
                        ...
                        child: Center(
                          child: customText.kText("Registration", 30, FontWeight.w700, Colors.white, TextAlign.center),
                        ),
                      ),
                      onTap: () {
