...
class UpdatedAdvertise extends StatefulWidget {
  const UpdatedAdvertise({super.key});

  @override
  State<UpdatedAdvertise> createState() => _UpdatedAdvertiseState();
}

class _UpdatedAdvertiseState extends State<UpdatedAdvertise> {
  dynamic size;
        ...
        if (phoneNoController.text.length == 10) {
          if (msgController.text.isNotEmpty &&
            ...
            if (addressController.text.isNotEmpty &&
              ...
              final response = await api.advertiseWithUs(
                nameController.text,
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: customText.kText("Advertise With Us", 30, FontWeight.w700,
