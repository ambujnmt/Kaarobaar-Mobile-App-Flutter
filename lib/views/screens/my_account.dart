        ...
        children: [
          ...
          Row(
            ...
            children: [
              SizedBox(
                ...
                child: customText.kText("My Account", 30, FontWeight.bold,
          ...
          Container(
            ...
            child: Align(
              ...
              child: customText.kText("User Name", 20, FontWeight.w500,
          ...
          Container(
            ...
            child: Align(
              alignment: Alignment.centerLeft,
              child: customText.kText("Email", 20, FontWeight.w500,
                  ColorConstants.kIconsGrey, TextAlign.start),
            ),
          ),
          SizedBox(
          ...
          Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  customText.kText("Password", 20, FontWeight.w500,
                      ColorConstants.kIconsGrey, TextAlign.start),
                  GestureDetector(
                    child: Align(
                        alignment: Alignment.bottomRight,
                        child: customText.kText("Change", 14, FontWeight.w500,
                            ColorConstants.kIconsGrey, TextAlign.right)),
                    onTap: () {
