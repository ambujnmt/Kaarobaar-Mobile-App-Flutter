...
class _AddBusinessState extends State<AddBusiness> {
  ...
  addBusiness() async {
    ...
    if(firstNameController.text.isNotEmpty && (!firstNameController.text.startsWith(" "))) {
      if(lastNameController.text.isNotEmpty && (!lastNameController.text.startsWith(" "))) {
        if(EmailValidator.validate(emailController.text)) {
          if(phoneController.text.length == 10) {
            if(businessNameController.text.isNotEmpty && (!businessNameController.text.startsWith(" "))) {
              if(businessTypeController.text.isNotEmpty && (!businessTypeController.text.startsWith(" "))) {
                if(businessAddressController.text.isNotEmpty && (!businessAddressController.text.startsWith(" "))) {
                  if(vatNoController.text.isNotEmpty && (!vatNoController.text.startsWith(" "))) {
            ...
            helper.errorDialog(context, "Please enter valid 10 digit phone number");
          }
        } else {
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: customText.kText("Add Business", 30, FontWeight.w700, Colors.black, TextAlign.start),
              ),
              TextField(
